 ...
 * project's `project.json` `tags` array as libraries and apps are
 * generated in later Sprint 0 milestones. Until those projects exist,
 * this rule has nothing to evaluate; it is not a placeholder, it is the
 * ratified policy waiting for its subjects.
 */
