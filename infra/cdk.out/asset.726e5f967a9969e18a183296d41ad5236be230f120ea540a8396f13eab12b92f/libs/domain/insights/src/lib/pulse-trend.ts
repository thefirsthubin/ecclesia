...
export const DEFAULT_PULSE_TREND_WINDOW_DAYS = 21;
 ...
 */
export const DEFAULT_PULSE_DECLINE_THRESHOLD_POINTS = 10;
 ...
 * "improved."
 */
export function evaluatePulseTrend(
  history: readonly PulseScorePoint[],
  now: Date,
  windowDays: number = DEFAULT_PULSE_TREND_WINDOW_DAYS,
  thresholdPoints: number = DEFAULT_PULSE_DECLINE_THRESHOLD_POINTS,
): PulseTrendEvaluation {
