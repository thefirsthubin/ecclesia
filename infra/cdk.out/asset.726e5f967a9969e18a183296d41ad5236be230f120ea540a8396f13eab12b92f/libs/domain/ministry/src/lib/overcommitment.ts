 ...
 */
export const DEFAULT_OVERCOMMITMENT_THRESHOLD = 4;
...
export function evaluateOvercommitment(
  concurrentCommitmentCount: number,
  threshold: number = DEFAULT_OVERCOMMITMENT_THRESHOLD,
): OvercommitmentEvaluation {
  return {
