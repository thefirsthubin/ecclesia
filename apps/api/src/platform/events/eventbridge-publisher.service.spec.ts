...
describe('EventBridgePublisherService', () => {
  const envelope: PublishableEngagementSignal = {
    ...
    payload: { gatheringId: 'g-1', status: 'PRESENT' },
  };
  ...
  it('publish() sends a PutEvents entry shaped from the envelope, with Source distinguishing apps/api from apps/worker', async () => {
