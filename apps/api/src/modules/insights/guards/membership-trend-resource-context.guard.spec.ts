...
import { MembershipTrendResourceContextGuard } from './membership-trend-resource-context.guard';
...
describe('[Milestone C] MembershipTrendResourceContextGuard', () => {
  it('resolves scope via GroupScopeService when a groupId query param is present', async () => {
    ...
    const guard = new MembershipTrendResourceContextGuard(branchConfigurationService as never, prisma as never, groupScopeService as never);
