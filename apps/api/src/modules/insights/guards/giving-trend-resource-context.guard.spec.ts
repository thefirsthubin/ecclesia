...
import { GivingTrendResourceContextGuard } from './giving-trend-resource-context.guard';
...
describe('[Milestone C] GivingTrendResourceContextGuard', () => {
  it('resolves scope via GroupScopeService when a groupId query param is present', async () => {
    ...
    const guard = new GivingTrendResourceContextGuard(branchConfigurationService as never, prisma as never, groupScopeService as never);
