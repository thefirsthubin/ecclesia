 ...
 * /insights/membership-trend` - reuses `people.person.read`. Identical
 * shape to `GivingTrendResourceContextGuard` - see that class's own doc
 * comment for the full reasoning. */
@Injectable()
export class MembershipTrendResourceContextGuard extends EcclesiaContextGuardBase {
  constructor(
