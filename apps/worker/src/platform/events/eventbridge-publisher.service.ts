...
export class EventBridgePublisherService {
   ...
   * site (a sweep job) is a compile error here, not a silent gap
   * discovered three layers downstream in Church Pulse scoring. See that
   * type's own doc comment for the full anti-drift chain this is one
   * link of.
   */
