 ...
 * pointed at the same `PeopleListWorkspace` instance - the real
  ...
  return render(
    <ThemeProvider>
      <ToastProvider>
        <RouterProvider>
          <Routes>
            <Route path="/people" element={<PeopleListWorkspace />} />
            <Route path="/people/:id" element={<PeopleListWorkspace />} />
          </Routes>
        </RouterProvider>
      </ToastProvider>
    </ThemeProvider>,
