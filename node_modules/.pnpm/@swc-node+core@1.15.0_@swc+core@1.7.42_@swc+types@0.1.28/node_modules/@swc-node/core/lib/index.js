...
function transformOption(path, options, jest = false) {
    ...
    return {
        ...
        jsc: ((_c = options === null || options === void 0 ? void 0 : options.swc) === null || _c === void 0 ? void 0 : _c.swcrc)
            ...
            : {
                ...
                transform: {
                    ...
                    decoratorVersion: (_e = opts.decoratorVersion) !== null && _e !== void 0 ? _e : '2021-12',
        ...
        minify: (_f = opts.minify) !== null && _f !== void 0 ? _f : false,
        isModule: true,
        module: ((_g = options === null || options === void 0 ? void 0 : options.swc) === null || _g === void 0 ? void 0 : _g.swcrc)
            ? undefined
            : {
                type: moduleType,
        ...
        sourceMaps: ((_h = options === null || options === void 0 ? void 0 : options.swc) === null || _h === void 0 ? void 0 : _h.swcrc)
            ? undefined
