 ...
 * decision record.
 */
export declare const ROLES: readonly ["RESIDENT_PASTOR", "ACTING_RESIDENT_PASTOR", "ASSISTANT_PASTOR", "BACENTA_LEADER", "BASONTA_LEADER", "TREASURER", "WORKER", "USHER", "MEMBER", "VISITOR", "ADMIN", "COUNCIL_OVERSEER"];
