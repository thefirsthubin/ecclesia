 ...
 * carry no such gate.
 */
export declare const ACTIONS: readonly ["people.person.create", "people.person.read", "people.person.update", "people.person.lifecycle_stage.read", "people.person.lifecycle_stage.update", "people.role_assignment.grant_shepherd", "people.role_assignment.grant", "people.role_assignment.update", "people.role_assignment.read", "people.group_membership.update", "people.group_membership.read", "people.group.create", "people.group.update", "people.group.read", "gatherings.gathering.create", "gatherings.gathering.update", "gatherings.gathering.read", "gatherings.attendance.create", "gatherings.attendance.read", "gatherings.visitor_intake.create", "gatherings.visitor_intake.read", "stewardship.transaction.record", "stewardship.transaction.verify", "stewardship.transaction.reconcile", "stewardship.transaction.read", "stewardship.expense.request", "stewardship.expense.approve", "stewardship.expense.pay", "stewardship.expense.receipt", "stewardship.expense.read", "stewardship.project.create", "stewardship.project.read", "stewardship.pledge.create", "stewardship.pledge.read", "stewardship.pledge.fulfill", "stewardship.bank_deposit.confirm", "stewardship.bank_deposit.read", "pastoral_care.followup_task.create", "pastoral_care.followup_task.update", "pastoral_care.followup_task.read", "pastoral_care.notes.read", "pastoral_care.notes.create", "pastoral_care.poimen_enrollment.create", "pastoral_care.poimen_enrollment.update", "pastoral_care.poimen_enrollment.read", "pastoral_care.silent_drift_flag.read", "insights.branch_dashboard.read", "insights.cluster_dashboard.read", "insights.bacenta_dashboard.read", "insights.alert.read", "insights.alert.resolve", "ministry.staffing_target.create", "ministry.staffing_target.read", "ministry.worker_availability.create", "ministry.worker_availability.read", "ministry.roster.read", "ministry.roster.overcommitment.read", "platform.configuration.create", "platform.configuration.update", "platform.configuration.read", "platform.audit_log.read"];
