...
exports.WCAG_AA_LARGE_TEXT_MIN_RATIO = exports.WCAG_AA_NORMAL_TEXT_MIN_RATIO = void 0;
exports.getRelativeLuminance = getRelativeLuminance;
exports.getContrastRatio = getContrastRatio;
exports.meetsWcagAaNormalText = meetsWcagAaNormalText;
...
exports.WCAG_AA_NORMAL_TEXT_MIN_RATIO = 4.5;
/** The Design System's §1.5 floor for large text (18px+/bold 14px+) and UI component boundaries. */
exports.WCAG_AA_LARGE_TEXT_MIN_RATIO = 3;
function meetsWcagAaNormalText(colorA, colorB) {
    return getContrastRatio(colorA, colorB) >= exports.WCAG_AA_NORMAL_TEXT_MIN_RATIO;
}
