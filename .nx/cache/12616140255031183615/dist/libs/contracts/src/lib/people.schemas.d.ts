...
export declare const ROLE_VALUES: readonly ["RESIDENT_PASTOR", "ACTING_RESIDENT_PASTOR", "ASSISTANT_PASTOR", "BACENTA_LEADER", "BASONTA_LEADER", "TREASURER", "WORKER", "USHER", "MEMBER", "VISITOR", "ADMIN", "COUNCIL_OVERSEER"];
export declare const roleSchema: z.ZodEnum<["RESIDENT_PASTOR", "ACTING_RESIDENT_PASTOR", "ASSISTANT_PASTOR", "BACENTA_LEADER", "BASONTA_LEADER", "TREASURER", "WORKER", "USHER", "MEMBER", "VISITOR", "ADMIN", "COUNCIL_OVERSEER"]>;
...
export declare const personResponseSchema: z.ZodObject<{
    ...
    id: string;
    branchId: string;
    lifecycleStage: "VISITOR" | "FIRST_TIME_GUEST" | "FOLLOW_UP" | "LAPSED" | "ASSIGNED_TO_BACENTA" | "SIX_WEEKS_PARTICIPATION" | "MEMBER";
    createdAt: string;
    updatedAt: string;
}, {
    firstName: string;
...
export declare const lifecycleTransitionRequestSchema: z.ZodObject<{
    ...
    toStage: "VISITOR" | "FIRST_TIME_GUEST" | "FOLLOW_UP" | "LAPSED" | "ASSIGNED_TO_BACENTA" | "SIX_WEEKS_PARTICIPATION" | "MEMBER";
...
export declare const createRoleAssignmentRequestSchema: z.ZodObject<{
    role: z.ZodEnum<["RESIDENT_PASTOR", "ACTING_RESIDENT_PASTOR", "ASSISTANT_PASTOR", "BACENTA_LEADER", "BASONTA_LEADER", "TREASURER", "WORKER", "USHER", "MEMBER", "VISITOR", "ADMIN", "COUNCIL_OVERSEER"]>;
    groupId: z.ZodOptional<z.ZodString>;
    scopeGroupIds: z.ZodDefault<z.ZodArray<z.ZodString, "many">>;
    effectiveFrom: z.ZodOptional<z.ZodString>;
}, "strip", z.ZodTypeAny, {
    role: "VISITOR" | "MEMBER" | "RESIDENT_PASTOR" | "ACTING_RESIDENT_PASTOR" | "ASSISTANT_PASTOR" | "BACENTA_LEADER" | "BASONTA_LEADER" | "TREASURER" | "WORKER" | "USHER" | "ADMIN" | "COUNCIL_OVERSEER";
...
export declare const listGroupsQuerySchema: z.ZodObject<{
    type: z.ZodOptional<z.ZodEnum<["PASTORAL_CARE", "MINISTRY"]>>;
}, "strip", z.ZodTypeAny, {
    type?: "PASTORAL_CARE" | "MINISTRY" | undefined;
}, {
    type?: "PASTORAL_CARE" | "MINISTRY" | undefined;
}>;
